...
/*cin >> fatura1.numero_item;
    cin.ignore();
    getline(cin, fatura1.descricao_item);
    cin >> fatura1.quant_item;
    cin >> fatura1.preco_item;
    
    
    cin >> fatura2.numero_item;
    cin.ignore();
    getline(cin, fatura2.descricao_item);
    cin >> fatura2.quant_item;
    cin >> fatura2.preco_item;*/
    ...
    /*x = getInvoiceAmount(fatura1.quant_item, fatura1.preco_item);
    y = getInvoiceAmount(fatura2.quant_item, fatura2.preco_item);*/

    /*cout << fatura1.numero_item << fatura1.descricao_item << fatura1.quant_item << fatura1.preco_item << fatura1.getInvoiceAmount() << "\n";
    cout << fatura2.numero_item << fatura2.descricao_item << fatura2.quant_item << fatura2.preco_item << fatura2.getInvoiceAmount() << "\n";*/


/*float getInvoiceAmount(int quant_item, float preco_item){
            return quant_item * preco_item;
        }*/
